...
describe('UserCard', () => {
    it('Should be render UserCard with correct props', () => {
        ...
        expect(getByText(/Software Painter |  UI Engineer/i)).toBeInTheDocument()
        ...
        expect(container.querySelector('img')).toHaveAttribute('src', 'https://avatars.githubusercontent.com/u/4243601?v=4')
        expect(container.querySelector('img')).toHaveAttribute('alt', 'Foto de perfil de William Oliveira')
    })
})